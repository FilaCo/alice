...
impl Entities {
    ...
    pub fn despawn(&mut self, entity: Entity) {
        ...
        self.storage[entity.position()] = holder;
    ...
    pub fn is_alive(&self, entity: Entity) -> bool {
        entity.generation() == self.storage[entity.position()].generation()
    }
    ...
    fn recycle(&mut self) -> Entity {
        ...
        let holder = self.storage[self.next_position];
...
mod tests {
    ...
    fn it_despawns_entity() {
        ...
        // assert
        assert_eq!(expected_available, entities.available);
        assert_eq!(entity.position(), entities.next_position);
        assert_eq!(expected_entity, entities.storage[entity.position()]);
    }
    ...
    fn it_recycle_entities() {
        ...
        // assert
        assert_eq!(expected_entities_len, entities.storage.len());
    }
}
